...
## Produces:
##   figures/sam3_ft_checkpoint18_score005_mask_vs_bbox.png  – combined mask vs bbox PR curve
...
ft_data <- data.table::fread(
  "data/finetuned/combined_results_sam3_ft_mask_5_checkpoint18_score_005_with_bb.csv"
) %>%
  as_tibble() %>%
...
cat("\n========== SAM3 FINE-TUNED (checkpoint 18, score 0.005, mask 0.50) ==========\n")
cat("IoU (mask):\n")
...
ggsave(
  "figures/sam3_ft_checkpoint18_score005_mask_vs_bbox.png",
  PR_plt,
  device = "png",
  width = 4, height = 4,
  scale = 2.75,
...
cat("Saved: figures/sam3_ft_checkpoint18_score005_mask_vs_bbox.png\n")
